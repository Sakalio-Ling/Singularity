...
class Agent:
    ...
    def connect(self) -> bool:
        ...
        if success:
            ...
            self._log_event("connect", {"status": "success"})
        else:
    ...
    def run_goal(self, goal: str) -> dict:
        ...
        self._log_event("goal_start", {"goal": goal})
        ...
        while self.running and cycle < max_cycles:
            ...
            try:
                ...
                self._log_event("observe", observation)
                ...
                self._log_event("error", {"cycle": cycle, "error": str(e)})
        ...
        self._log_event("goal_end", result)
        return result
...
{{"analysis": "...", "suggestion": "...", "should_retry": true/false}}"""
        ...
        try:
            ...
            return {"analysis": "Could not parse reflection", "suggestion": "retry", "should_retry": True}
...
Available actions: move_to, look_at, dig, place, craft, attack, equip, open_container, chat, wait
...
What actions should I take next? Output JSON."""
    ...
    def _log_event(self, event_type: str, data: dict):
        ...
        logger.debug(f"[{event_type}] {json.dumps(data, ensure_ascii=False)[:200]}")
